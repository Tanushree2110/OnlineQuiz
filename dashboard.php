    ...
    <nav class="navbar navbar-inverse  navbar-fixed-top title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b> Quiz Club</b></a>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==0)
                {
                  echo '<span style="color:white;text-align:center;margin-left:100px; font-size:60px;">Welcome to Admin Panel!</span>';
